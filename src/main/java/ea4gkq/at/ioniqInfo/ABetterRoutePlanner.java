...
import ea4gkq.at.ioniqInfo.greencar.BatteryChargeListener;
import ea4gkq.at.ioniqInfo.greencar.EVPowerDisplayListener;
import ea4gkq.at.ioniqInfo.greencar.GreenCarGwEvP06ExtraListener;
import ea4gkq.at.ioniqInfo.hvac.HvacTempListener;

public class ABetterRoutePlanner {
  public static final String TAG = "at.ea4gkq.ABRP";
  public static final String ABETTERROUTEPLANNER_USER = "YOUR_MAIL_HERE";
  ...
  public static final String ABETTERROUTEPLANNER_SESSION_ID = "e56794306818";
  ...
  private static void sendUpdate() {
    ...
    mLogger.log(new Pair<String, Object>("mLat", mLat),
        new Pair<String, Object>("mLon",mLon),
        new Pair<String, Object>("mAlt", mAlt),
        new Pair<String, Object>("mSoc", mSoc),
        new Pair<String, Object>("mTemperature", mTemperature),
        new Pair<String, Object>("mCarSpeed", mCarSpeed),
        new Pair<String, Object>("mKwEngine", mKwEngine),
        new Pair<String, Object>("mKwElecticalDevice", mKwElecticalDevice),
        new Pair<String, Object>("mKwAircon", mKwAircon),
        new Pair<String, Object>("mKwHeating", mKwHeating)
    );
  }
  ...
  private static String buildUrl(Pair<String, Object>... queryParams) throws UnsupportedEncodingException {
    StringBuilder url = new StringBuilder(ABETTERROUTEPLANNER_URL)
        .append("?").append(ABETTERROUTEPLANNER_EMAIL).append("=").append(URLEncoder.encode(ABETTERROUTEPLANNER_USER, "UTF-8"))
    ...
    try {
      ...
      asyncHttpClient.get(url, new AsyncHttpResponseHandler() {
        ...
        public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
          mLogger.log("send status: " + statusCode);
        }

        @Override
        public void onFailure(int statusCode, Header[] headers, byte[] responseBody, Throwable error) {
          mLogger.log("send status: " + statusCode, error);
        }
      });
